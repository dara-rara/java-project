...
public class ObjectVK {
    ...
    private static final HashMap<String, Integer> citiesNumbers = new HashMap<>();
    ...
    public static void createMapCity() {
        var offset = 0;
        var totalMembers = 0;
        var maxMembers = 1000;
        do {
    ...
    public static HashMap<String, String> getMapCity() {
        return cities;
    }

    public static HashMap<String, Integer> getCitiesNumbers() {
